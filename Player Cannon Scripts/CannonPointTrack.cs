...
public class CannonPointTrack : MonoBehaviour
{
    ...
    public float grabSensitivity = 0.8f;
    ...
    void Update(){
        ...
        if (OVRInput.Get(OVRInput.Axis1D.PrimaryHandTrigger) > grabSensitivity) {
        ...
        if (OVRInput.Get(OVRInput.Axis1D.SecondaryHandTrigger) > grabSensitivity) {
